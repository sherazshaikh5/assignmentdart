...
void main() {
  ...
  print(stdmarks);
  print(
      "Student Name is ${stdlist[0]} Percentage is ${stdmarks[0] / 500 * 100}");
  print(
      "Student Name is ${stdlist[1]} Percentage is ${stdmarks[1] / 500 * 100}");
  print(
      "Student Name is ${stdlist[2]} Percentage is ${stdmarks[2] / 500 * 100}");
  print("\n");
